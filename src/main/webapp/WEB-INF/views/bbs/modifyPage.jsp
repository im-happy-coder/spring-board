      ...
      <section>
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <form class="form-horizontal style-form" method="post" role="form" action="/start/bbs/modifyPage">
	          	  ...
	          	  <script type="text/javascript">
	          	  	...
	          	  	$(document).ready(function(){
	          	  		...
	          	  		$("#btn_save").on("click", function(){
	          	  			/* frmObj.attr("action", "/start/bbs/modifyPage"); */
							frmObj.submit();	          	  			
	          	  		});
	          	  		
	          	  		$("#btn_cancel").on("click", function(){
	          	  			/* self.location="/start/bbs/pageList"; */
	          	  			self.location="/start/bbs/pageList?page=${pCri.page}&numPerPage=$pCri.numPerPage}";
	          	  		});
	          	  	});
	          	  </script> 
          		</div><!-- col-lg-12-->      	
