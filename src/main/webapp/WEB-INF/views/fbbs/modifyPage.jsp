      ...
      <section>
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <form class="form-horizontal style-form" method="post" role="form" action="/fbbs/modifyPage">
	          	  ...
	          	  <script type="text/javascript">
	          	  	...
	          	  	$(document).ready(function(){
	          	  		...
	          	  		$("#btn_cancel").on("click", function(){
	          	  			...
	          	  			self.location="/fbbs/pageList?page=${fCri.page}&numPerPage=$fCri.numPerPage}"
